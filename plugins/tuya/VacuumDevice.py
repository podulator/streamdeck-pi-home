...
# sudo ufw allow proto udp from 192.168.178.1/16 to any port 6666,6667
...
class VacuumDevice(tinytuya.Device):
    ...
    def clean(self, nowait=False) -> None:
    ...
    def pause(self, nowait=False) -> None:
    ...
    def charge(self, nowait=False) -> None:
